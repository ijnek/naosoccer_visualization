...
public:
  ...
  : Node("RobotArrayToMarkerArray")
  {
    ...
    subscriber_ = this->create_subscription<naosoccer_interfaces::msg::RobotArray>(
      "vision/robots", 1,
      [this](naosoccer_interfaces::msg::RobotArray::SharedPtr robotArray) {
...
private:
  visualization_msgs::msg::Marker convert(int markerId, naosoccer_interfaces::msg::Robot & robot)
  {
    visualization_msgs::msg::Marker marker;
    marker.header = robot.header;
    marker.ns = "";
    marker.id = markerId;
  ...
  rclcpp::Subscription<naosoccer_interfaces::msg::RobotArray>::SharedPtr subscriber_;
};
