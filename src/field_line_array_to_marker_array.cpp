...
public:
  ...
  : Node("FieldLineArrayToMarkerArray")
  {
    ...
    subscriber_ = this->create_subscription<naosoccer_interfaces::msg::FieldLineArray>(
      "vision/field_lines", 1,
      [this](naosoccer_interfaces::msg::FieldLineArray::SharedPtr fieldLineArray) {
...
private:
  visualization_msgs::msg::Marker convert(int markerId, naosoccer_interfaces::msg::FieldLine & line)
  {
  ...
  rclcpp::Subscription<naosoccer_interfaces::msg::FieldLineArray>::SharedPtr subscriber_;
};
